...
% This script applies the Semi-Classical Signal Analysis (SCSA) method as 
        ...
        for type_clf= type_clf_list
            ...
            for Negative_sample_ratio_TS=-1%[1  -1];
                for Negative_sample_ratio_TR=-1%[1  3];
                    ...
                    %% Apply the SCSA feature extraction method
                         SCSA_Feature_extraction_and_Classification
